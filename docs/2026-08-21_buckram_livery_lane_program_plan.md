...
| 12 | Floats and shapes | **In progress** | Horizontal box-valued shapes now use rectangular or circular rounded line-exclusion areas while margin-box placement, clearance, avoidance, and containment remain unchanged. The rounded slice adds eight exact shape-box and full-CSS gains with zero loss, on top of the rectangular slice's two gains. The shared inline/block residual is next. See the [rectangular](2026-08-25_buckram_float_shape_boxes_reconciliation.md) and [rounded](2026-08-25_buckram_rounded_shape_boxes_reconciliation.md) reconciliations. |
