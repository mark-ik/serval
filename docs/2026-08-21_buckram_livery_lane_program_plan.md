...
| 17 | Counters, lists, generated content | Livery `content`/`counter-*` cascade and marker boxes | **In progress:** the [scripted-host wave](../design_docs/2026-09-06_scripted_host_capabilities_plan.md) includes a native inside-disc marker slice. Counters, outside markers, authored generated content, and the frozen WPT comparison remain open. No WPT gain is claimed. |
